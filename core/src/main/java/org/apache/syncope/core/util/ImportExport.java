...
public class ImportExport extends DefaultHandler {
    ...
    public Table getTable(final String tableName) {
        JDBCConfiguration conf = (JDBCConfiguration) ((OpenJPAEntityManagerSPI) entityManager).getConfiguration();
        ...
        SchemaGroup group = tool.getSchemaGroup();

        return group.findTable(QualifiedDBIdentifier.getPath(DBIdentifier.newTable(tableName)));
    }
}
